...
public class BankAccount {
	...
	public void transferFunds(BankAccount dest, double amount) throws BankingException {
		...
		if (this.isActive && dest.isActive) {
			...
			throw new BankingException("Invalid acountS");
	}
	public void simpleinterest(double per,double timeperiod) {
//		String s = "SAVING";
//		if(AcctType.values().equals(s))
		this.balance = (this.balance*per*timeperiod)/100;
